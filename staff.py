...
def digitalevi():
	...
	if 'submit' in request.form:
		...
		# return redirect(url_for('staff.stff_evi_btn'))
...
def staff_verify_digital_evidence():
	...
	if action=="verify":
		s="update video_audio set va_status='verified' where crime_num='%s'"%(cid)
		print(s)
		update(s)
		q="select * from video_audio where crime_num='%s'"%(cid)
		res=select(q)
		if res:
			...
			flash("verified successfully")
			return redirect(url_for('staff.staff_evi_verify',cid=cid))
